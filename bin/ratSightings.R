...
pdf("results/ratsXlocationType.pdf")
print(l + geom_bar(width=0.75) + xlab("Borough") + ylab("Rat Sightings") + ggtitle("Rat Sightings by Borough and Structure") + theme(axis.text.x = element_text(angle = 45, hjust = 1), legend.position="none"))
dev.off()
...
#How many sightings have been taken care of?
table(!is.na(as.Date(ratData$Closed.Date, "%m/%d/%Y")))
